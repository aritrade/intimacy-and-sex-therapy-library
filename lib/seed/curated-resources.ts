...
export const CURATED_RESOURCES: Curated[] = [
  ...
  },
  {
    ...
    language: "en",
    license: "oa_pmc",
    externalUrl: "https://pubmed.ncbi.nlm.nih.gov/23559141/",
    abstract:
  ...
  },
  {
    ...
    language: "en",
    license: "copyrighted",
    externalUrl: "https://www.simonandschuster.com/books/Come-As-You-Are-Revised-and-Updated/Emily-Nagoski/9781982165314",
    abstract:
  ...
  },
  {
    ...
    language: "en",
    license: "copyrighted",
    externalUrl: "https://www.crucible4points.com/books/resurrecting-sex-overview/",
    abstract:
      "Differentiation-based approach to long-term sexual difficulties (low desire, mismatch, performance anxiety) in committed relationships. The author's official Crucible Approach overview page links to retailers for the HarperCollins paperback. Metadata-only.",
    kind: "book",
  ...
  },
  {
    ...
    language: "en",
    license: "copyrighted",
    externalUrl: "https://elisabethsheff.com/books/",
    abstract:
      "15-year longitudinal ethnography of polyamorous families in the United States, published by Rowman & Littlefield. Linked here via the author's official book index, which lists all editions and retailer links. Metadata-only.",
    kind: "book",
    tags: ["polyamory", "open_relationships", "intermediate"],
  },
  ...
  },
  {
    ...
    language: "en",
    license: "copyrighted",
    externalUrl: "https://www.aasect.org/position-sexual-expression-including-orientation-and-identity",
    abstract:
      "AASECT position affirming all sexual orientations and identities (explicitly including asexuality) and opposing therapy that pathologises or attempts to change a person's sexual orientation, identity, or consensual expression.",
    kind: "guideline",
  ...
  },
  {
    ...
    language: "en",
    license: "copyrighted",
    externalUrl: "https://mhi.org.in/resources/",
    abstract:
      "India-first practice guidelines and reports on queer-affirmative counselling and related topics — explicitly written for the Indian socio-legal context post-Section 377 reading-down. Linked here via MHI's resources index, which lists all current publications including the QACP manual.",
    kind: "guideline",
  ...
  },
  {
    ...
    language: "en",
    license: "copyrighted",
    externalUrl: "https://fpaindia.org/our-work/young-people",
    abstract:
      "FPA India's Comprehensive Sexuality Education (CSE) programme for young people aged 10–24, covering the seven-module CSE curriculum (gender, SRH and HIV, sexual rights and citizenship, pleasure, violence, diversity, and relationships). Page also describes the school/college and out-of-school delivery models and the peer-educator approach.",
    kind: "article",
    tags: ["india", "psychoeducation", "beginner"],
  },
  ...
  // ---------------------------------------------------------------------------
  {
    ...
    language: "en",
    license: "copyrighted",
    externalUrl: "https://www.acog.org/clinical/clinical-guidance/committee-opinion/articles/2018/05/optimizing-postpartum-care",
    abstract:
      "ACOG Committee Opinion No. 736 (May 2018). Reframes postpartum care as an ongoing process rather than a single 6-week visit, with first contact within 3 weeks and a comprehensive visit by 12 weeks. Covers screening for sexual concerns, mood, contraception, and chronic-disease management.",
    kind: "guideline",
  ...
  // ---------------------------------------------------------------------------
  {
    sourceSlug: "cornell-health",
    title: "Sensate Focus — A Stage-by-Stage Guide for Couples (Cornell Health)",
    authors: ["Cornell Health"],
    authorCredentials: [
      "Cornell Health student-health service; based on Masters, Johnson & Kolodny, Heterosexuality (HarperCollins, 1994)",
    ],
    publishedAt: new Date("2020-01-01"),
    language: "en",
    license: "copyrighted",
    externalUrl: "https://health.cornell.edu/sites/health/files/pdf-library/sensate-focus.pdf",
    abstract:
      "Cornell Health's printable sensate-focus guide. Stepwise non-genital and genital touch exercises adapted from Masters and Johnson for couples working through performance anxiety, low desire, or post-illness sexual difficulties. Explicitly note that the exercises are adaptable for couples of all sexes, genders, and orientations.",
    kind: "worksheet",
